...
export const translations = {
  th: {
    ...
    svgLayoutMode: "สัดส่วนภาพพรีวิวและดาวน์โหลด",
    layoutAuto: "ความสูงตามเนื้อหา (แบบเดิม)",
    layoutLandscapeA4: "แนวนอน A4 (สัดส่วน 1.41:1)",
    layoutWidescreen: "แนวนอนจอกว้าง (สัดส่วน 16:9)",
    previewStyle: "สไตล์การพรีวิว",
    previewMermaid: "โครงร่างดราฟต์ (Mermaid)",
    previewExport: "ภาพส่งออกจริง (WYSIWYG)",
    ...
    inviteCollaborators: "เชิญเพื่อนร่วมงาน",
    inviteCollaboratorsDescription: "เชิญเพื่อนร่วมงานเข้ามาดูหรือแก้ไขแผนภูมินี้แบบเรียลไทม์",
    emailAddress: "ที่อยู่อีเมล",
    emailPlaceholder: "กรอกอีเมลเพื่อนร่วมงาน",
    role: "สิทธิ์การเข้าถึง",
    roleEditor: "ผู้แก้ไข (Editor) - สามารถอ่านและแก้ไขได้",
    roleViewer: "ผู้เข้าชม (Viewer) - อ่านได้อย่างเดียว",
    inviteButton: "ส่งคำเชิญ",
    inviting: "กำลังเชิญ...",
    invitedCollaborators: "รายชื่อผู้มีสิทธิ์เข้าถึง",
    owner: "เจ้าของ (Owner)",
    revokeAccess: "เพิกถอนสิทธิ์",
    revoking: "กำลังเพิกถอน...",
    collaboratorOnlyOwnerCanInvite: "เฉพาะเจ้าของโปรเจกต์เท่านั้นที่เชิญเพื่อนร่วมงานได้",
    collaboratorSignInRequired: "กรุณา Sign in ก่อนจัดการสิทธิ์การร่วมงาน",
    templates: "เทมเพลตและนำเข้า",
    templatesDescription: "นำเข้าโครงสร้างแผนภูมิ Driver Diagram จากตัวอย่างงานคุณภาพโรงพยาบาล หรือสแกนจากรูปภาพ/PDF ด้วย AI",
    selectTemplate: "เลือกแผนภูมิตัวอย่าง",
    importTemplate: "นำเข้าแผนภูมิ",
    importSuccess: "นำเข้าแผนภูมิตัวอย่างสำเร็จ",
    uploadDiagramFile: "อัปโหลดภาพหรือไฟล์ PDF แผนภูมิ",
    uploadHint: "ลากไฟล์มาวางที่นี่ หรือคลิกเพื่อเลือกไฟล์ (รองรับ PNG, JPG, PDF)",
    aiImportBtn: "สแกนด้วย AI",
    aiImporting: "กำลังประมวลผลด้วย AI...",
    aiImportSuccess: "สแกนและนำเข้าข้อมูลด้วย AI สำเร็จ",
    ...
    editDiagramForm: "แก้ไขแผนภูมิ",
    navigatorCollapse: "ซ่อนสารบัญ",
    navigatorExpand: "แสดงสารบัญ",
    formOutline: "โครงสร้างแผนภูมิ",
    navigationHint: "💡 คีย์บอร์ด: กด Enter เพื่อไปช่องถัดไป | กด Shift+Enter เพื่อขึ้นบรรทัดใหม่",
    collapseEditor: "ซ่อนกล่องแก้ไข",
    expandEditor: "แสดงกล่องแก้ไข",
    printDiagram: "พิมพ์แผนภูมิ",
    printDiagramShort: "พิมพ์",
  },
  en: {
    ...
    svgLayoutMode: "Export Image Layout",
    layoutAuto: "Fit Content (Default)",
    layoutLandscapeA4: "Landscape A4 (1.41:1)",
    layoutWidescreen: "Landscape Widescreen (16:9)",
    previewStyle: "Preview Style",
    previewMermaid: "Mermaid Draft",
    previewExport: "Export Visual (WYSIWYG)",
    openSharedView: "Open shared view",
    openGallery: "Open gallery",
    backToGallery: "Back to gallery",
    galleryTitle: "Community Gallery",
    ...
    inviteCollaboratorsDescription: "Invite colleagues to view or edit this diagram in real-time.",
    emailAddress: "Email Address",
    emailPlaceholder: "Enter collaborator's email",
    role: "Access Role",
    roleEditor: "Editor - Can read and edit",
    roleViewer: "Viewer - Read-only access",
    inviteButton: "Send Invite",
    inviting: "Inviting...",
    invitedCollaborators: "People with Access",
    owner: "Owner",
    revokeAccess: "Revoke Access",
    revoking: "Revoking...",
    collaboratorOnlyOwnerCanInvite: "Only the project owner can invite collaborators.",
    collaboratorSignInRequired: "Please sign in before managing collaborator permissions.",
    templates: "Templates & Import",
    templatesDescription: "Import a Driver Diagram structure from clinical examples or scan a PDF/image using AI.",
    selectTemplate: "Select a Template",
    importTemplate: "Import Diagram",
    importSuccess: "Imported template successfully.",
    uploadDiagramFile: "Upload Diagram Image or PDF",
    uploadHint: "Drag and drop your file here, or click to browse (PNG, JPG, PDF)",
    aiImportBtn: "Scan with AI",
    aiImporting: "Processing with AI...",
    aiImportSuccess: "Scanned and imported successfully via AI.",
    ...
    editDiagramForm: "Edit Diagram",
    navigatorCollapse: "Hide outline",
    navigatorExpand: "Show outline",
    formOutline: "Diagram Outline",
    navigationHint: "💡 Keyboard: Press Enter to move to next field | Shift+Enter to insert a newline",
    collapseEditor: "Collapse Editor",
    expandEditor: "Expand Editor",
    printDiagram: "Print Diagram",
    printDiagramShort: "Print",
  },
};
